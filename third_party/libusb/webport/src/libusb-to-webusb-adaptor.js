...
GSC.LibusbToWebusbAdaptor = class extends GSC.LibusbToJsApiAdaptor {
  constructor() {
    super();
    /**
     * @type {!Map<number, !Object>} Mapping from IDs (generated by us) into
     * USBDevice objects (returned by the API).
     */
    this.idToWebusbDeviceMap_ = new Map();
    /** @type {number} The counter that's used for generating new device IDs. */
  ...
  async listDevices() {
    ...
    // programmatically recreate a USBDevice object.
