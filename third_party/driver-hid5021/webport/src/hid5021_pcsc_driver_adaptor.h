...
#ifndef GOOGLE_SMART_CARD_THIRD_PARTY_DRIVER_HID5021_HID5021_PCSC_DRIVER_ADAPTOR_H_
#define GOOGLE_SMART_CARD_THIRD_PARTY_DRIVER_HID5021_HID5021_PCSC_DRIVER_ADAPTOR_H_
...
class Hid5021PcscDriverAdaptor : public PcscDriverAdaptor {
 public:
  ...
  const std::string& GetDriverFileName() const override;
...
#endif  // GOOGLE_SMART_CARD_THIRD_PARTY_DRIVER_HID5021_HID5021_PCSC_DRIVER_ADAPTOR_H_
