...
goog.provide('GoogleSmartCard.ConnectorApp.ChromeApiTestUtils');
 ...
 */
GoogleSmartCard.ConnectorApp.ChromeApiTestUtils.setUpMockForExtensionApi =
    function(mockControl, propertyReplacer) {
