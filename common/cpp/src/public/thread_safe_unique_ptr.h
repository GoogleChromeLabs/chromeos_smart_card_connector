...
#ifndef GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_THREAD_SAFE_UNIQUE_PTR_H_
#define GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_THREAD_SAFE_UNIQUE_PTR_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_THREAD_SAFE_UNIQUE_PTR_H_
