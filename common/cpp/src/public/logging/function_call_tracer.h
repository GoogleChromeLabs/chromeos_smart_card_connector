...
#ifndef GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_LOGGING_FUNCTION_CALL_TRACER_H_
#define GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_LOGGING_FUNCTION_CALL_TRACER_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_LOGGING_FUNCTION_CALL_TRACER_H_
