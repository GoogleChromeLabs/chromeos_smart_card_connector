...
#ifndef GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_VALUE_BUILDER_H_
#define GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_VALUE_BUILDER_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_VALUE_BUILDER_H_
