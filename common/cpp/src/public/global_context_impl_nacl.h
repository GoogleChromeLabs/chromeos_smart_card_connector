...
#ifndef GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_GLOBAL_CONTEXT_IMPL_NACL_H_
#define GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_GLOBAL_CONTEXT_IMPL_NACL_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_GLOBAL_CONTEXT_IMPL_NACL_H_
