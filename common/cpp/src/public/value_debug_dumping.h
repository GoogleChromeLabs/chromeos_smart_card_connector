...
#ifndef GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_VALUE_DEBUG_DUMPING_H_
#define GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_VALUE_DEBUG_DUMPING_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_VALUE_DEBUG_DUMPING_H_
