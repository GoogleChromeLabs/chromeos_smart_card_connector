...
#ifndef GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_OPTIONAL_H_
#define GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_OPTIONAL_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_CPP_SRC_PUBLIC_OPTIONAL_H_
