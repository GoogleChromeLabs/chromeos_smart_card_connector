...
#ifndef GOOGLE_SMART_CARD_COMMON_REQUESTING_REQUEST_RECEIVER_H_
#define GOOGLE_SMART_CARD_COMMON_REQUESTING_REQUEST_RECEIVER_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_REQUESTING_REQUEST_RECEIVER_H_
