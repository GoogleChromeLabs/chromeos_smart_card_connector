...
GSC.PopupOpener.runModalDialog = function(
  ...
  goog.global[`googleSmartCard_resolveModalDialog${popUpId}`] = promiseResolver.resolve;
  goog.global[`googleSmartCard_rejectModalDialog${popUpId}`] = promiseResolver.reject;
