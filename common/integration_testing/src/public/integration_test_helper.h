...
#ifndef GOOGLE_SMART_CARD_COMMON_INTEGRATION_TESTING_SRC_PUBLIC_INTEGRATION_TEST_HELPER_H_
#define GOOGLE_SMART_CARD_COMMON_INTEGRATION_TESTING_SRC_PUBLIC_INTEGRATION_TEST_HELPER_H_
...
#endif  // GOOGLE_SMART_CARD_COMMON_INTEGRATION_TESTING_SRC_PUBLIC_INTEGRATION_TEST_HELPER_H_
